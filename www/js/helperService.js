'use strict';
angular.module('starter').service('helperService', function() {
	this.hello = function() {
		return "Hello World";
	};
...
.service('awsService', function(localStorageService) {
	var topics = [ {
		...
		desc : 'Urinary System',
		id : 1,
		url : 'data/img/kidney.png'
	}, {
		title : 'Biochemistry',
		desc : 'Identity and Access Management',
		id : 2,
		url : 'data/img/biochemistry.jpg'
	}, {
		title : 'Diabetes',
		desc : 'Simple Storage Service',
		id : 3,
		url : 'data/img/diabetes.png'
	}, {
		title : 'Neuroanatomy',
		desc : 'Relational Database Service',
		id : 4,
		url : 'data/img/brain.png'
	}, {
		title : 'Circulation',
		desc : 'Elastic Compute Cloud',
		id : 5,
		url : 'data/img/circulation.png'
	}, {
		title : 'Pathology',
		desc : 'Simple Workflow Service',
		id : 6,
		url : 'data/img/pathology.png'
	}, {
		title : 'Syndromes',
		desc : 'Subnets, NACLs, Gateways, IPs',
		id : 7,
		url : 'data/img/syndromes.png'
	}, {
		title : 'Respiration',
		desc : 'Easy to begin, Impossible to outgrow',
		id : 8,
		url : 'data/img/respiration.png'
	}, {
		title : 'Pharmacology 1',
		desc : 'Pharmacology 1',
		id : 9,
		url : 'data/img/pill.png'
	}, {
		title : 'Pharmacology 2',
		desc : 'Push Notification Service',
		id : 10,
		url : 'data/img/pill.png'
	}, {
		title : 'Physiology',
		desc : 'Amazons NoSQL Database',
		id : 11,
		url : 'data/img/organism.png'
	}, {
		title : 'Nervous system',
		desc : 'Templates and Stacks',
		id : 12,
		url : 'data/img/nervous.png'
	}, {
		title : 'Lymphatic System',
		desc : 'Templates and Stacks',
		id : 13,
		url : 'data/img/lymphatic.png'
	}, {
		title : 'Gastrointestinal',
		desc : 'Templates and Stacks',
		id : 14,
		url : 'data/img/stomach.png'
	}, {
		title : 'Integumentary',
		desc : 'Templates and Stacks',
		id : 15,
		url : 'data/img/skin.png'
	}, {
		title : 'Behavioral Science',
		desc : 'Templates and Stacks',
		id : 16,
		url : 'data/img/mind.png'
	} ];
	...
	var patientPopulation = [ {
		title : 'Adult CCRN',
		id : 17,
		url : 'data/img/adult.png'
	}, {
		title : 'Pediatric CCRN',
		id : 18,
		url : 'data/img/pediatric.png'
	}, {
		title : 'Neonatal CCRN',
		id : 19,
		url : 'data/img/neonatal.png'
	}

	];

	var arrayOfTopics = [ topics, mockExams, patientPopulation ];
	...
	return {
		...
		updateScoreForTopics : function(topicId, score) {
			...
			arrayOfTopics.forEach(function(topicSection) {
				topicSection.forEach(function(topic, index) {
					if (topic.id == topicId) {
